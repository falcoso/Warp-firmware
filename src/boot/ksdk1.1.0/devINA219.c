...
configureSensorINA219(uint8_t payloadF_SETUP, uint8_t payloadCTRL_REG1, uint16_t menuI2cPullupValue)
{
	...
	i2cWriteStatus2 = writeSensorRegisterINA219(kWarpSensorConfigurationRegisterINA219F_CALIB /* register address F_SETUP */,
							payloadF_SETUP /* payload: Disable FIFO */,
							menuI2cPullupValue);
...
printSensorDataINA219(bool hexModeFlag)
{
	...
	i2cReadStatus = readSensorRegisterINA219(kWarpSensorOutputRegisterINA219OUT_CALIBRATION, 2 /* numberOfBytes */);
	readSensorRegisterValueMSB = deviceINA219State.i2cBuffer[0];
	readSensorRegisterValueLSB = deviceINA219State.i2cBuffer[1];
	readSensorRegisterValueCombined = ((readSensorRegisterValueMSB & 0xFF) << 6) | (readSensorRegisterValueLSB >> 2);
